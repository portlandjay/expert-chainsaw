...
activities = {
    ...
    "Basketball Team": {
        "description": "Compare in basketball tournaments and practice skills",
    ...
    "Swimming Club": {
        ...
        "max_participants": 12,
        "participants": ["isabella@mergington.edu", "aviva@mergington.edu"]
    },
    "Art Studio": {
        "description": "Create and display artwork in various mediums",
        "schedule": "Fridays, 2:00 PM - 3:30 PM",
        "max_participants": 18,
        "participants": ["mia@mergington.edu", "elena@mergington.edu"]
    },
    "Drama Club": {
    ...
    # Additional intellectual activity
    "Math Club": {
        "description": "Learn advanced math concepts and solve problems together",
